...
ENTRYPOINT ["/usr/bin/tini","--"] # nosemgrep: dockerfile.security.missing-user-entrypoint.missing-user-entrypoint
CMD ["/entrypoint.sh"] # nosemgrep: dockerfile.security.missing-user.missing-user
